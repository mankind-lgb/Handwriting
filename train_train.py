...
def train_on_device(args):
    ...
    transform = A.Compose([
        ...
        A.ShiftScaleRotate(rotate_limit=(-5,5),scale_limit=(-0.3,0.3), p=1),
        A.RandomCrop(args.img_shape[0],args.img_shape[1]),
    ])

    dataset = train_dataset(data_root=args.data_path, image_list=images_list['all_patch'], transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', type=int, default=20)  # 700
